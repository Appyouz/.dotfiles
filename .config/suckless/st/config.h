...
/* static char *font = "Fira Code Nerd Font:size=16:style:normal:antialias=true:autohint=true"; */
static char *font = "Fira Code Nerd Font:size=16:style:medium:antialias=true:autohint:true";
