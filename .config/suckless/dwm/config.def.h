...
static const char *fonts[]          = { "OpenDyslexic Nerd Font:size=10:style:bold" };
...
// static const char *volupcmd[] = {"pamixer", "-i", "5", "--allow-boost", NULL};
// static const char *voldowncmd[] = {"pamixer", "-d", "5", "--allow-boost", NULL};
